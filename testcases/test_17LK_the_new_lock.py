...
@ddt
class TestLKTheNewLock(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        headers['token']=token
        cls.token=headers
        id_1 = jsonpath(res, "$..id")[0]
        cls.id_1=id_1
    #---------------------------------------------------


    excel=HandleExcel(os.path.join(DATA_DIR,"apicases.xlsx"),"17_lk_the_new_lock")
    #读取用例数据
