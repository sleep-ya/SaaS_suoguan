...
class TestNBNewPassword(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.token=headers
    #---------------------------------------------------
    excel=HandleExcel(os.path.join(DATA_DIR,"apicases.xlsx"),"02_nb_new_password_2")
    #读取用例数据
    ...
    #等待提示语
    print("请激活设备，等待时间100s")
    time.sleep(100)#这个是针对上一模块消耗所需时间
    print("等待时间结束，跳转下一个测试，指纹门锁，如果设置中非指纹门锁自动跳过")#这条提示语是针对本模块
