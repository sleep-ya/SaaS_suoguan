...
@ddt
class TestLKaSingleQuery(unittest.TestCase):
    ...
    excel=HandleExcel(os.path.join(DATA_DIR,"apicases.xlsx"),"16_lk_a_single_query")
    #读取用例数据
    ...
    @list_data(cases)
    def test_lk_a_single_query(self,item):
        #门锁类型获取
