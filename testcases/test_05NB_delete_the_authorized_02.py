# -*- coding:utf-8 -*-
# @Time   : 2021/1/20 14:51
# @Author :sleep
# @Email  :1285592010@qq.com
# @File   : test_05NB_delete_the_authorized_01.py
# @Software:PyCharm
# @File name Translation:删除授权"还是有问题为了不耽误时间，先往后写"
import unittest
import os
import requests
import time
...
@ddt
class TestNBdeleteTheAuthorized(unittest.TestCase):
    ...
    #---------------------------------------------------
    excel=HandleExcel(os.path.join(DATA_DIR,"apicases.xlsx"),"05_delete_the_authorized_2")
    #读取用例数据
